export function problem(lines) {
    ...
    function acimaDiagonalPrincipal() {
        const matriz = data()
        const acimaDiagonal = []
        ...
        return acimaDiagonal.map(Number)

    }

    function somar() {
        const acimaDiagonal = acimaDiagonalPrincipal()
        let soma = 0

        for(let i = 0; i < acimaDiagonal.length; i++) {
            soma += acimaDiagonal[i]
        }
    ...
    function media() {
        ...
        for(let i = 0; i < acimaDiagonal.length; i++) {
            total += acimaDiagonal[i]
        }

        const media = total / acimaDiagonal.length
...
if(matriz.linha1.length < 12) {
    ...
    matriz.linha0.length >= 12 ? matriz.linha1.push(i) : matriz.linha0.push(i)
    
} else if(matriz.linha2.length < 12) {

    matriz.linha1.length >= 12 ? matriz.linha2.push(i) : matriz.linha1.push(i)

} else if(matriz.linha3.length < 12) {

    matriz.linha2.length >= 12 ? matriz.linha3.push(i) : matriz.linha2.push(i)

} else if(matriz.linha4.length < 12) {

    matriz.linha3.length >= 12 ? matriz.linha4.push(i) : matriz.linha3.push(i)

} else if(matriz.linha5.length < 12) {

    matriz.linha4.length >= 12 ? matriz.linha5.push(i) : matriz.linha4.push(i)

} else if(matriz.linha6.length < 12) {

    matriz.linha5.length >= 12 ? matriz.linha6.push(i) : matriz.linha5.push(i)

} else if(matriz.linha7.length < 12) {

    matriz.linha6.length >= 12 ? matriz.linha7.push(i) : matriz.linha6.push(i)

} else if(matriz.linha8.length < 12) {

    matriz.linha7.length >= 12 ? matriz.linha8.push(i) : matriz.linha7.push(i)

} else if(matriz.linha9.length < 12) {

    matriz.linha8.length >= 12 ? matriz.linha9.push(i) : matriz.linha8.push(i)

} else if(matriz.linha10.length < 12) {

    matriz.linha9.length >= 12 ? matriz.linha10.push(i) : matriz.linha9.push(i)

} else if(matriz.linha11.length < 12) {

    matriz.linha10.length >= 12 ? matriz.linha11.push(i) : matriz.linha10.push(i)
